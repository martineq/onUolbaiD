...
void ControladorEvento::setTeclaDApretada(bool apretada){
	this->teclaDApretada = apretada;	
	this->notificarAlProxy();
}

void ControladorEvento::setTeclaFApretada(bool apretada){
	this->teclaFApretada = apretada;		
	this->notificarAlProxy();
}
